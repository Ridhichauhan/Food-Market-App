...
const Food = () => {
  const data = [
    {title:"Cucumeber and shrink salad", price:"$" , quantity:"3" ,img:"meal.png"},
    {title:"Vegestables and steak", price:"$" , quantity:"3" ,img:"meal.png"},
  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex bg-[#43405D] rounded-2xl h-[5.6vh] w-[74vw] mt-24 ml-14 ">
        <input type="text" className="bg-[#43405D] ml-8 outline-none pl-10 text-[#dddd]"
          style={{
      ...
      <h1 className="flex ml-16 mt-4 font-bold text-2xl text-[#574E6D]">Asian Cucumber Salad</h1>
      ...
      <div className="flex bg-[#dddd] w-[96vw] h-[8vh] mt-16 ml-2 rounded-full">
       ...
       <img alt="" src="homee.png" className="h-14 w-14 ml-10 mt-[-16px] "></img>
